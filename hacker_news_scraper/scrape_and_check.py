...
#             page = requests.get(
#                 f'https://news.ycombinator.com/news?p={counter}')
...
# pprint.pprint(create_custom_hn(sc.link_generator()[
#               0], sc.link_generator()[1], votes=sc.votes))
...
class Scrape_Dou(object):
    ...
    def link_generator(self):
        ...
        while counter < self.quantity:
            page = requests.get(f'https://jobs.dou.ua/vacancies/?category=Python')
